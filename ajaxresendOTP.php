        ...
        if (empty($_POST['email'])){
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                if (count($validateemail) > 0){
                    ...
                    while(1){
                        $validateotpsql = "SELECT oid FROM login_otp WHERE otp = '".$otp."' AND email = '".$email."' ";
                    ...
                    $mail->Body = '
                        ...
                        Your <strong>Resent</strong> OTP towards validating your mail address is <strong>'.$otp.'.</strong><br>
